...
def contains_disallowed(text):
    ...
    banned_words = ["viewer", "zuschauer", "viewers", "views", "buy", "follower", "best", "free", "sell", ".com", "commision", "***"]
    return any(word in text for word in banned_words) or bool(re.findall(r"[A-Z|a-z]+\.[A-Z|a-z]{2,3}\b", text))